...
export const JOINTS: JointSpec[] = [
  {
    ...
    submissions: [
      {
        name: "裸絞め / mata-leão",
        how: "首への圧迫を伴う絞め技。顎を引くだけでは防げない。首に向かう腕への手の対応が必要で、防御できないときは早めにタップする",
      },
      {
        name: "三角絞め / triângulo",
  ...
  },
  {
    ...
    limitedBy: "肘頭と上腕骨の形状、関節包、側副靭帯など。伸展角度には個人差があり、0°は安全限界を示す値ではない",
    failureMode:
      "強い過伸展や横方向の力で靭帯・関節包などが損傷しうる。角度だけでは負荷や損傷の有無は判断できない",
    submissions: [
      {
        name: "腕十字 / 十字固め / juji-gatame",
        how: "腕を支配し、肘の伸展方向に力をかける関節技。角度の数値ではタップ時点を決められない。腕を孤立させないことと、捕まったら早めに止める判断を学ぶ",
      },
    ],
  ...
  },
  {
    ...
    failureMode: "股関節の動きや骨盤の向きを制限されると、脚を戻す動きや姿勢の変更がしづらくなる",
    submissions: [
      {
        name: "(直接のサブミッションは少ない)",
        how: "ブリッジ・海老・角度の変更には股関節が関わる。骨盤・体幹・足の支持などとの協調で、体の位置を変える",
      },
    ],
    note: "ガードでは股関節の動きに加え、膝・骨盤・体幹の位置が関わる。大きな可動域だけでガードが保てるわけではない。",
  },
  {
    id: "knee",
    jp: "膝関節",
