...
- Claude が作業を完了した後、必要に応じて `code-reviewer` と `codex` と並行してレビューする
- 自分は可読性・一貫性・保守性に集中し、コード品質・安全性や最終確認は他レビュアーと役割分担する
- 並行レビュー時も、自分の観点での指摘と評価を独立して報告する
